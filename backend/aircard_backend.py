...
script_dir = Path(getattr(sys, "_MEIPASS", Path(__file__).resolve().parents[1]))
...
from backend.apply_card_skin import (
    native,
    operation_ok,
    write_file,
    write_files_batch,
...
from backend.card_assets import CACHE_FILES, build_card_assets
from backend.card_export import classify_card, export_card
from backend.card_cache import get_cached_card, save_cached_card
from backend.aircard import (
    find_device_helper,

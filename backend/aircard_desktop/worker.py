...
def main(argv):
    ...
    try:
        ...
        if sys.platform == "win32":
            from backend.windows_airtraffic import AirTraffic
            from backend.windows_apple_runtime import CoreFPRegistration
            ...
            if job.get("checkSync"):
                ...
                if not binary.is_file():
                    binary = Path(__file__).resolve().parents[2] / "build" / "airtraffic_host"
